...
export default function ShortcutBox() {
  ...
  return (
    <div className={"min-h-9 min-w-36 fixed bottom-4 left-4 text-white px-4 py-2 rounded-lg shadow-lg text-sm pointer-events-none select-none transition-colors " + c}>
      {text}
    </div>
  );
}
